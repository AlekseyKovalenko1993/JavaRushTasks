...
public class Solution {
            ...
            public int compare(Stock o1, Stock o2) {
                if(o1.containsKey("change")){
                    if(o2.containsKey("change")){
                        return (double)o1.get("change") >= (double)o2.get("change") ? -1 : 1;
                    }else{
                        return (double)o1.get("change") >= ((double)o2.get("last") - (double)o2.get("open")) ? -1 : 1;
                    }
                }else if(o2.containsKey("change")){
                    return (double)o1.get("last") >= ((double)o2.get("open") - (double)o2.get("change")) ? -1 : 1;
                }else
                    return ((double)o1.get("open") - (double)o1.get("change")) >= ((double)o2.get("open") - (double)o2.get("change")) ? -1 : 1;
            }
        })));
    }
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 125.61, 123.43));
